...
function oneWinner(){
  ...
  if($(".game div div.top-left , .game div div.top-center ,.game div div.top-right").children(".x").length === 3){
          console.log("player one is win "); score_one++;
    ...
    $(".container , .playerone h4").css("display","block" );
          ...
          console.log("player one is win "); score_one++; $(".container , .game div div ").css("cursor","not-allowed");
           $(".container , .playerone h4").css("display","block" );
...
function twoWinner(){
  ...
  if($(".game div div.top-left , .game div div.top-center ,.game div div.top-right").children(".o").length === 3){
     ...
     score_two++;
          ...
          console.log("player two is win "); score_two++; $(".container , .game div div ").css("cursor","not-allowed");
...
function restart(){
  ...
  $(".container .game div div").children("img").remove();
    player = "one";
  $(".container .playerone h2 ,.container .playeronr img").css({"opacity":"1","transform":"scale(1,1)"});
  $(".container .playertwo h2 ,.container .playertwo img").css({"opacity":".8","transform":"scale(.8,.8)"});
...
$(function() {
  ...
  $(".game div div").click(function() {
    ...
    if( $(".container").css("cursor") ==="not-allowed"){
      ...
      if (player === "one"){
      $(this).append("<img class= 'x'src='images/x4.jpg' width='"+$(this).css("width")+"' height='"+$(this).css("height")+"'>");
      player = "two";
        $(".container .playerone h2 , .container .playerone img").css({"opacity":".8","transform":"scale(.8,.8)"});
        ...
        $(this).append("<img img class= 'o' src='images/o4.jpg' width='"+$(this).css("width")+"' height='"+$(this).css("height")+"'>");
      player = "one";
         $(".container .playertwo h2 ,.container .playertwo img").css({"opacity":".8","transform":"scale(.8,.8)"});
    ...
    if($(".game div div").children("img").length === 9 && $(".container .playerone h4").css("display")==="none"
      &&  $(".container .playertwo h4").css("display")==="none"){
      $("body h1 ").fadeIn(500);
